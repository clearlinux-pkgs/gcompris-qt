...
Source0  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-25.0.tar.xz
Source1  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-25.0.tar.xz.sig
...
%setup -q -n gcompris-qt-25.0
cd %{_builddir}/gcompris-qt-25.0
pushd ..
cp -a gcompris-qt-25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738365198
mkdir -p clr-build
pushd clr-build

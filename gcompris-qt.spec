...
Source0  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-4.2.tar.xz
Source1  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-4.2.tar.xz.sig
...
%setup -q -n gcompris-qt-4.2
cd %{_builddir}/gcompris-qt-4.2
pushd ..
cp -a gcompris-qt-4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727198322
mkdir -p clr-build
pushd clr-build

...
Version  : 4.0
Release  : 23
URL      : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-4.0.tar.xz
Source0  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-4.0.tar.xz
Source1  : https://download.kde.org/stable/gcompris/qt/src/gcompris-qt-4.0.tar.xz.sig
...
%prep
%setup -q -n gcompris-qt-4.0
cd %{_builddir}/gcompris-qt-4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708527185
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gcompris-qt-%{version}/LICENSES/CC-BY-SA-%{version}.txt %{buildroot}/usr/share/package-licenses/gcompris-qt/218ff5d31a950e718669755000fd08bf864a50ab || :
